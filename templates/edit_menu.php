...
mkSelect("id_menu", $listeMenus,"id_menu", "name", false, false, "", "Menu à supprimer");
...
mkInput("number", "price", "", "placeHolder=\"Prix (en €)\"  step=\"0.5\"");
mkInput("submit", "action", "Creer Menu");
endForm();
echo "</br></br>";

$listeProduit = recupererProduits();
echo "<h3>Ajouter un produit à un menu</h3>";
mkForm("controleur.php");
mkSelect("id_menu", $listeMenus,"id_menu", "name", false, false, "", "Sélectionnez un menu");
mkSelect("id_product", $listeProduit,"id_product", "name", false, false, "", "Produit à ajouter");
